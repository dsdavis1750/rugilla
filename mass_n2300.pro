...
beta = 0.410      ; slope of surface brightness
n0 = 3.11e-3      ; central electron number density
;
; radial vector
x = findgen(1000) + 1.
x = (x / 101.)      ; set range from 0 - 10 rcore
...
!xtitle = 'Radius (kpc)'
;
;x_plot = x*rcore*1000./1200 ; plot in units of R_vir
...
!p.title = 'Mass profile - NGC 2300 Group'
!p.linestyle = 0
...
; Entropy plot
!p.linestyle = 0
!p.title = 'Entropy profile - NGC 2300 Group'
!ytitle='Entropy (keV cm!u2!d)'
;plot_oi,x_plot,entropy,yrange=[30.,250.],xrange=[1.0,300.]
plot,x_plot,entropy,yrange=[30.,250.],xrange=[x_min,x_max]
;plot,x_plot,entropy,yrange=[30.,250.],xrange=[1.0,3.00]
;
; Density plot
!p.linestyle = 0
!p.title ='Density profile - NGC 2300 Group'
!ytitle='n!de!n (cm!u-3!d)'
plot_oo,x_plot,n_elec,yrange=[1.e-4,4.e-3],xrange=[x_min,x_max]
;
; temperature plot
!p.title ='Temperature profile - NGC 2300 Group'
!ytitle='T(keV)'
